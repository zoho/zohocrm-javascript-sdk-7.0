...
This repository includes the JAVASCRIPT SDK for API v7 of Zoho CRM. Check [Versions](https://github.com/zoho/zohocrm-javascript-sdk-7.0/releases) for more details on the versions of SDK released for this API version.
...
- [1.0.0](/versions/1.0.0/README.md)
    ...
    - JavaScript SDK upgraded to support v7 APIs.
...
For older versions, please [refer](https://github.com/zoho/zohocrm-javascript-sdk-7.0/releases).
